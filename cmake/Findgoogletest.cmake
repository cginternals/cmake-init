...
# googletest_FOUND
# Target googletest-dev

# GLEW_BINARY (win32 only)

include(FindPackageHandleStandardArgs)

find_path(GOOGLETEST_PROJECT_DIR googletest/googletest/include/gtest/gtest.h
    PATHS
    $ENV{GOOGLETEST_DIR}
    /usr/src
    /usr/local/src
    ...
    DOC "The directory where googletest/googletest/include/gtest/gtest.h resides")
...
if (googletest_FOUND)
    ...
    add_subdirectory("${GOOGLETEST_PROJECT_DIR}/googletest" "${PROJECT_BINARY_DIR}/googletest")
    ...
    target_include_directories(googletest
        SYSTEM INTERFACE
        ${GOOGLETEST_PROJECT_DIR}/googletest/googletest/include
        ${GOOGLETEST_PROJECT_DIR}/googletest/googlemock/include
    )
